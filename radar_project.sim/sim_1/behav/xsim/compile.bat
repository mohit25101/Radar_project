...
REM
REM Generated by Vivado on Thu May 28 16:42:33 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_radar_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_radar_vlog.prj -log xvlog.log
